...
class QuestionModelTest(TestCase):
    ...
    def setUp(self):
        self.question = Question(question_text='¿Quién soy yo?')
    ...
    def test_was_published_recently_with_past_questions(self):
        '''
        was_published_recently return False for questions whose pub_date is in the present
        '''
...
class QuestionDetailViewTest(TestCase):
    ...
    def test_future_question(self):
        ...
        future_question = create_question(
            question_text='Future question 1', days=30)
        # sin la coma python no lo consideraria como tupla
